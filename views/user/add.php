                                        ...
                                        <div class="shadow p-3 mb-5 bg-body rounded">
                                            <form name="formAdd" id="formAdd" class="formAdd" method="post" class="form-control " action="<?php echo DIRPAGE . 'controllers/ControllerAdd.php'; ?>">
                                                ...
                                                <label for="inicio" class="form-label">
                                                    <h6>Inicio:</h6>
                                                </label><input type="time" name="time" id="time"  class="form-control form-control-sm time" value="<?php echo $date->format("
                                                H:i"); ?>" required>

                                                <label for="fim" class="form-label">
                                                    <h6>Final:</h6>
                                                </label><input type="time" name="fim" id="fim"  class="form-control form-control-sm fim" value="<?php echo $date->format("
                                                H:i"); ?>" required>

                                                <label for="professor" class="form-label">
                                                    <h6>Professor:</h6>
                                                </label><input type="text" name="title" id="title"  placeholder="ex:Prof.Davidson" class="form-control form-control-sm title" required>
                                                <label for="email" class="form-label">

                                                    <h6>email:</h6>
                                                </label><input type="text" name="email" id="email"  placeholder="ex:andreluiz@outlook.com" class="form-control form-control-sm email" required>
                                                ...
                                                <div class="form-floating">
                                                    ...
                                                    <textarea class="form-control description" placeholder="Leave a commentde" name="description" id="description"   style="height: 100px"></textarea>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" id="itapoa" name="campus" class="campus" required value="Itapoã" onclick="ver_sala_itapoa()" class="form-check-input">
                                                    <label class="form-check-label" for="inlineRadio1">Itapoã</label>
                                                </div>
                                                <div class="form-check form-check-inline ">
                                                    <input type="radio" id="jaragua" name="campus" class="campus" required value="Jaraguá" onclick="ver_sala_jaragua()" class="form-check-input">
                                                ...
                                                <select name="reserva" id="opcao" class="form-select " aria-label="Default select example" hidden>
                                             ...
                                             <!-- incluindo um script do servidor dos e-mail  -->
...
Email.send({
    //F4ED4A967046782CDBA3743BBC504FC1042F603117D4402AD13C4CFC97BD126938FC6B68547CB60203F4749AB7E5B309
    Host : "smtp.elasticemail.com",
    Username : "unifenasinformatica@gmail.com",
    Password : "2197C5DB6501B7700012B499B805110CE661",
    To : email.value,
    From : 'unifenasinformatica@gmail.com',
  ...
  message => alert(message)
    ...
    // adicionar um evento no botão submit
